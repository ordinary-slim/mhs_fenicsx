...
void declare_create_robin_robin_monolithic(nb::module_ &m) {
  ...
  m.def(
      ...
      [](dolfinx::fem::FunctionSpace<double>& Qs_gamma,
         ...
         nb::ndarray<const double, nb::ndim<2>, nb::c_contig> permuted_gauss_points_cell,
         ...
         nb::ndarray<const double, nb::ndim<3>, nb::c_contig> geoms_cells_mesh_j)
      {
        ...
        Mat A  = create_robin_robin_monolithic<double>(Qs_gamma,
                        ext_conductivity,
                        std::span(tabulated_gauss_points_gamma.data(), tabulated_gauss_points_gamma.size()),
                        std::span(permuted_gauss_points_cell.data(), permuted_gauss_points_cell.size()),
